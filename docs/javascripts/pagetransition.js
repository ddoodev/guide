...
!async function () {
  if (window.jQuery && window.innerWidth > 1220) {
    ...
    * */
    ...
    /*
    * - What the hell is going on from above???
    * I do not know why, but this library breaks the content on mobile phones.
    * Just importing it will break everything.
    * So we import it like this... On pc only.
    * */
